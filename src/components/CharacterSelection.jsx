...
import { characterParts, getSelectedCharacter, setSelectedCharacter } from '../utils/characterData';
          ...
          {characterParts.bodies.map((b) => (
            <img
              ...
              style={{
                width: '60px',
                cursor: 'pointer',
                border: b === body ? '2px solid #3498db' : '2px solid transparent',
                borderRadius: '8px'
              }}
              onClick={() => setBody(b)}
            />
          ...
          {characterParts.hats.map((h) => (
            <img
              ...
              style={{
                width: '60px',
                cursor: 'pointer',
                border: h === hat ? '2px solid #e74c3c' : '2px solid transparent',
                borderRadius: '8px'
              }}
              onClick={() => setHat(h)}
            />
