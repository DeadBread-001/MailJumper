...
const Shop = () => {
  ...
  const renderPrizeCard = (prize, isPromoCode = false) => (
      <div key={prize.id} className={`prize-card ${userCoins >= prize.price ? 'available' : 'locked'}`}>
        ...
        <div className="prize-details">
          {isPromoCode && (
              <div className="promo-info">
                <span className="expiry-date">Срок действия: {timeConvert.dateIntoDayMonthYear(prize.active_to)}</span>
